...
_G['string'].slit = function(subject, delimiter)
  local ret = {}
...
_G['hooksecurefunc'] = function(...)
    ...
    if type(arg[1]) == 'string' then
        ...
        local functionId = getFunctionId(func)
    ...
    -- hook member function
        ...
        local functionId = getFunctionId(tbl[functionName])
...
_G['replacehooksecurefunc'] = function(...)
    -- hook global function
    if type(arg[1]) == 'string' then
        local functionName = arg[1]
        local hookFunction = arg[2]
